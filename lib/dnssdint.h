...
#define RAOP_CN "0,1"           /* Audio codec: PCM, ALAC, AAC, AAC ELD */
#define RAOP_ET "5"           /* Encryption type: None, FairPlay, FairPlay SAPv2.5 */
#define RAOP_VV "2"
#define RAOP_FT "0x30e483c5a00"
